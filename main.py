...
def generate_image(scene_concept, count):
    ...
    visual_prompt += "PHYSICS & REALISM: While stylized, the scene must adhere to basic physical laws. Gravity applies. People and objects must be firmly grounded on solid surfaces. No walking on liquid water, flying without aircraft, or impossibly floating structures.\n"
